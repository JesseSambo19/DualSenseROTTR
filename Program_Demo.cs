...
//         static Process[] gameProcessName = Process.GetProcessesByName("SOTTR");
...
//             {
//                 Console.WriteLine("SOTTR.exe not found. Waiting for the game to start...\n");
//             }

//             while (gameProcessName.Length == 0)
//             {
//                 // Check if the game process is running
//                 gameProcessName = Process.GetProcessesByName("SOTTR");
...
//             Console.WriteLine("========================================");
//             Console.WriteLine(" Shadow of the Tomb Raider DualSense Mod v1.0.0 by Jexar");
//             Console.WriteLine(" Enhancing DualSense support for Shadow of the Tomb Raider");
//             Console.WriteLine("========================================\n");
...
//             mem.OpenProcess("SOTTR");
//             // Get the base address from game process
//             // baseAddress = mem.GetModuleBase("SOTTR.exe");
...
//             // string weaponTypePointer = "SOTTR.exe+03588250,10,E48,10,8A8,2D0,2C0,354";
//             string weaponTypePointer = "SOTTR.exe+035ADDF0,48,50,10,90,380,8,2E0";
//             string isHoldingWeaponPointer = "SOTTR.exe+0360FC98,2B0,6B8,0,2C0,8,898,5B0";
//             // string aimWeaponPointer = "SOTTR.exe+03690398,D70,0,440,D40,160,2CC";
//             string aimWeaponPointer = "SOTTR.exe+1E77A80";
//             // string shootWeaponStatePointer = "SOTTR.exe+035E6518,18";
//             // string shootWeaponStatePointer = "SOTTR.exe+2F83748";
//             // string shootWeaponStatePointer1 = "SOTTR.exe+2F836C0";
//             string shootWeaponStatePointer = "SOTTR.exe+14982CC";
//             // string pauseStatesPointer = "SOTTR.exe+30141EC";
//             string pauseStatesPointer = "806F16E8";
//             // string drawBowPointer = "SOTTR.exe+023596E0,60,40,4B0,2E0,8,B8,E8";
//             string cutscenePointer = "SOTTR.exe+02FAED78,28,7F8,48,50,10,E8,2A0";
//             string cutscene2Pointer = "SOTTR.exe+1497B98";
//             string machinegunAmmoPointer = "SOTTR.exe+035E5D58,2E8,280,298,10,28,48,C";
...
//             //     if (gameProcessName.Length == 0)
//             //     {
//             //         Console.WriteLine("SOTTR.exe not found. Exiting...\n");
...
//                     bool leftTriggerPressed = ds4LeftTriggerPressed || ((xinputResult == 0) && (controllerState.Gamepad.bLeftTrigger > 40)); // Higher threshold to avoid noise
...
//                     Console.WriteLine($"Weapon Type: {weapon_type} | Is Holding Weapon: {isHoldingWeapon} | Is Aiming: {isAimingWeapon} | Shoot Weapon State: {shootWeaponState} | Pause States: {pauseStates} | Cutscene: {cutscene} | Machinegun Ammo: {machinegunAmmo} | Is Holding Pick Axe: {isHoldingPickAxe} | Cutscene2: {cutscene2}");
//                     if (
//                         // false
...
//                         // // bool hasDualPistolsEquipped = default_weapon_type == 31985484 && isAimingWeapon == 65536 && (edge == 177 || dualPistols == 588) && ((isHoldingWeapon2 > 0 && isHoldingWeapon2 != 69 && isHoldingWeapon2 != 704 && action == 0) || (secondIsHoldingWeapon2 > 0 && secondIsHoldingWeapon2 != 69 && secondIsHoldingWeapon2 != 704 && secondAction == 0)); // original
//                         // bool hasDualPistolsEquipped = default_weapon_type == 31985484 && isAimingWeapon == 65536 && ((edge == 177 && traversal == 512) || dualPistols == 588) && location == 33 && ((isHoldingWeapon2 > 0 && isHoldingWeapon2 != 69 && isHoldingWeapon2 != 704 && (action == 0 || action > 0 && isHoldingFireStriker1 > 0)) || (secondIsHoldingWeapon2 > 0 && secondIsHoldingWeapon2 != 69 && secondIsHoldingWeapon2 != 704 && (secondAction == 0 || secondAction > 0 && secondIsHoldingFireStriker1 > 0)));

//                         // if (xinputResult == 0 || DS4Reader.TryReadState(out _))
...
//                             if (isAimingWeapon == 65536 && isHoldingWeapon == 65537)
//                             {
//                                 p.instructions[1].type = InstructionType.TriggerThreshold;
...
//                             // if (isAimingWeapon == 65536 && drawBow == 17)
//                             // {
//                             //     if (!r2Held)
//                             //     {
