...
namespace DualSenseROTTR
{
    public static class Functions
    {
        public static bool IsValidMemory(
            Tuple<IntPtr, int[]>? weaponTypePointer,
        ...
        public static void CheckPlatform(string platform, string fileVersion, string productVersion, MemoryReader mem)
        {
            ...
            else if (platform == "Microsoft Store")
            {
                ...
                Console.WriteLine("This platform of Rise of the Tomb Raider is not supported by the mod.");
                Console.WriteLine($"This {platform} version of Rise of the Tomb Raider (product version: {productVersion}, file version: {fileVersion}) could not be identified by the mod.");
                Console.WriteLine("This mod only works on Rise of the Tomb Raider: 20 Year Celebration from the following platforms:");
                ...
                Console.WriteLine("  GOG:");
                Console.WriteLine("    - product version: 1.0, file version: 1.0.1.2 (latest build)");
                Console.WriteLine("    - product version: 1.0, file version: 1.0.1.1 (older build)");
                Console.WriteLine("    - product version: 1.0, file version: 1.0.1.0 (even older build)");
            ...
            else if (platform == "Unknown")
            {
                Console.WriteLine("Rise of the Tomb Raider DualSense Mod initialization failed.");
                Console.WriteLine($"Platform: {platform}");
                Console.WriteLine("This platform of Rise of the Tomb Raider could not be identified by the mod.");
                Console.WriteLine("This mod only works on Rise of the Tomb Raider: 20 Year Celebration from the following platforms:");
                Console.WriteLine("  - Steam");
                Console.WriteLine("  - Epic Games Store");
                Console.WriteLine("  - GOG");
            ...
            else
            {
                Console.WriteLine("Rise of the Tomb Raider DualSense Mod initialization failed.");
                Console.WriteLine($"Platform: {platform}");
                Console.WriteLine($"This {platform} version of Rise of the Tomb Raider (product version: {productVersion}, file version: {fileVersion}) is not supported by the mod.");
                Console.WriteLine("Supported versions:");
                Console.WriteLine("  Steam:");
                Console.WriteLine("    - product version: 1.0, file version: 1.0.0.0 (latest build)");
                Console.WriteLine("    - product version: 1.0, file version: 1.0.1026.0 (older build)");
